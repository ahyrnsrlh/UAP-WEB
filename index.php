          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Kinclongkan kendaraan anda bersama Unila Steam</p>
                    </div>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.html" class="navbar-brand"><i class="fa fa-u-square"></i>UNILA STEAM</a>
               </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p>Unila Steam merupakan salah satu bidang usaha yang menawarkan jasa perawatan kendaraan berupa pencucian dan pembersihan kendaraan.</p>
                              </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              ...
                              <div class="contact-info">
                                   ...
                                   <p><i class="fa fa-envelope-o"></i> <a href="#">info@unilasteam.com</a></p>
                              </div>
                         </div>
                    </div>
